...
export default function Range() {
    ...
    return (
      ...
      <div className="Containor">
        <div className="grid md:grid-cols-3 px-[131px]">
          {categories.map((category) => (
            ...
            >
              <div className="relative h-[480px] w-[381px] overflow-hidden rounded-lg gap-5 ">
                <Image
                  src={category.image}
                  alt={category.alt}
                  fill
              ...
              <h3 className="text-[24px] font-semibold text-gray-800 mt-[30px]">
                {category.title}
              </h3>
            </Link>
          ))}
